...
CITY_DISPLAY_MAP = {
    ...
    "Кириши": "Кириши",
    "Екатеринбург": "Екатеринбург *",  # Нет на Busfor
    "Новосибирск": "Новосибирск *",  # Нет на Busfor
    "Краснодар": "Краснодар",
    "Уфа": "Уфа",
    "Красноярск": "Красноярск *",  # Нет на Busfor
    "Владивосток": "Владивосток",
    "Рыбинск": "Рыбинск",
    "Великий Новгород": "Великий Новгород",  # Добавлено
    "Нижний Новгород": "Нижний Новгород",  # Добавлено
    "Волгоград": "Волгоград",
    "Воронеж": "Воронеж",
    "Смоленск": "Смоленск",
    "Брянск": "Брянск",
    "Весьегонск": "Весьегонск",
    "Кострома": "Кострома **",  # Только из Москвы на Busfor
    "Ярославль": "Ярославль **"  # Только из Москвы на Busfor
}
    ...
    if st.button("🔍 Поиск рейсов", type="primary", use_container_width=True):
        if from_city and to_city and search_date:
            ...
            with st.spinner("Идет поиск рейсов... Это может занять несколько минут..."):
                ...
                # if "e-traffic" in selected_sources:
                #     try:
...
with col2:
    ...
    **Примечания к городам:**
    - `*` - Города, которые могут отсутствовать на некоторых источниках (например, Busfor)
    - `**` - Города, доступные для поиска только из определенных пунктов на некоторых источниках
    """)
